                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <form action="{{ route('searcher') }}" method="GET" role="search">
                                <div class="form-group has-search">
                                    <span class="fa fa-search form-control-feedback"></span>
                                    <input type="text" id="search-location-input" name="search_location_input" class="form-control ui-autocomplete-input" placeholder="Search where to find your restaurant">
                                </div>
                            </form>
                        </div>
                    </div>
